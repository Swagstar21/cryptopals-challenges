...
Robert Panduru
2018
This is the first challenge that requires using "real life"
cryptography means. Just an import and a few lines of code
"""
...
decipher = AES.new("YELLOW SUBMARINE", AES.MODE_ECB)
